        ...
        <div className="grid grid-cols-1 lg:grid-cols-[150px_1fr_180px] xl:grid-cols-[200px_1fr_200px] gap-8 items-start">
          ...
          <div className="flex flex-col gap-4 pt-2">
            <p className="text-[15px] leading-relaxed text-text-secondary max-w-[480px]">
              ...
              и эстетичные интерфейсы. Люблю сложные задачи, внимание к деталям
              и чистый код.
            </p>
            <p className="text-[15px] leading-relaxed text-text-secondary max-w-[480px]">
          ...
          <div className="flex flex-row md:flex-col gap-8 md:gap-5">
            <div className="flex flex-col gap-1">
              <span className="text-[32px] font-extrabold text-text leading-none">
                3+
              </span>
              <span className="text-[10px] text-text-secondary tracking-[0.08em] uppercase">
                года опыта
              </span>
            </div>
            <div className="flex flex-col gap-1">
